...
map.setOptions({zoomControl:true, scrollwheel: false ,navigationControl: false,
    ...
    styles: styles
      ...
      var regionChoords = [
/*  {lat: 56.045258, lng: 12.57902},//UU øresund
     {lat:55.6393767, lng:12.647270400000025},
       {lat:55.616498, lng:12.363156},
       {lat:55.846145, lng:12.062191},
       
      {lat:56.0272537, lng:12.19100960000003},*/
...
new google.maps.LatLng(56.678865,9.319153)
  ...
  bermudaTriangle.setMap(map);
   ...
   var born = new google.maps.Polygon({
    paths: bornholm,
    strokeColor: '#fff',
    strokeOpacity: 0.8,
    strokeWeight: 2,
   ...
   var zeland = new google.maps.Polygon({
    paths: Zeland,
    strokeColor: '#fff',
    strokeOpacity: 0.8,
    strokeWeight: 2,
   ...
   var mJylland = new google.maps.Polygon({
    paths: midtjylland,
    strokeColor: '#fff',
    strokeOpacity: 0.8,
    strokeWeight: 2,
   ...
   var njutland = new google.maps.Polygon({
    paths: northjutland,
    strokeColor: '#fff',
    strokeOpacity: 0.8,
    strokeWeight: 2,
  ...
  njutland.addListener('click', show);
  
  function show(){
 infoWindow = new google.maps.InfoWindow;
 
 var contentString = 'Region Nordjylland';

    infoWindow.setContent(contentString);
    infoWindow.setPosition(new google.maps.LatLng(57.163057,9.860229));
